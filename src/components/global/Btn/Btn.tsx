...
const Btn = ({
  ...
  return (
    <button
      className={`flex max-w-full cursor-pointer items-center justify-center border transition-colors duration-300 ${generateBtnTheme()} ${generateBtnShape()} ${classes ? classes : ""} [&_svg]:h-7 [&_svg]:w-7 [&_svg]:fill-current [&_svg]:stroke-current`}
      onClick={handleClick}
