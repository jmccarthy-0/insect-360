...
const PhotoInfo = ({
  photoMeta: { description, cameraModel, lens, flash, stacker },
}: PhotoInfoProps) => {
  ...
  return (
    <div className="w-full bg-primary-light px-page-x pb-4 pt-16 text-primary-dark dark:bg-primary-dark dark:text-primary-light ">
